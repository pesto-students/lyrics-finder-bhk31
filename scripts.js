...
let getLyricsLink = (buttonName) => document.getElementsByClassName(buttonName);

let addEventToButton = (buttonName, event, fn) => {
    Array.from(buttonName).forEach(function (element) {
